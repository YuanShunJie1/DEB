...
class TopModelForMnist(nn.Module):
    ...
    def forward(self, input_tensor_top_model_a, input_tensor_top_model_b, agged_inputs=None, agged=False, return_activations=False):
        activations = {}
        if agged:
...
class BottomModelForUCIHAR0(nn.Module):
    def __init__(self):
        super(BottomModelForUCIHAR0, self).__init__()
        self.fc1 = nn.Linear(281, 20)
        self.fc2 = nn.Linear(20, 10)
...
class BottomModelForUCIHAR1(nn.Module):
    def __init__(self):
        super(BottomModelForUCIHAR1, self).__init__()
        self.fc1 = nn.Linear(280, 20)
        self.fc2 = nn.Linear(20, 10)
...
class TopModelForUCIHAR(nn.Module):
    def __init__(self):
        super(TopModelForUCIHAR, self).__init__()
        self.fc1top = nn.Linear(20, 20)
        self.fc2top = nn.Linear(20, 10)
        self.fc3top = nn.Linear(10, 21)
        self.bn0top = nn.BatchNorm1d(20)
...
class FC_UCIHAR(nn.Module):
    def __init__(self, num_passive):
        super(FC_UCIHAR, self).__init__()
        self.num_passive = num_passive
        self.passive = nn.ModuleList([
            BottomModelForUCIHAR0().cuda(),
            BottomModelForUCIHAR1().cuda(),           
        ])
        self.active = TopModelForUCIHAR().cuda()
...
class BottomModelForPHISHING0(nn.Module):
    def __init__(self):
        super(BottomModelForPHISHING0, self).__init__()
...
class BottomModelForPHISHING1(nn.Module):
    def __init__(self):
        super(BottomModelForPHISHING1, self).__init__()
        self.fc1 = nn.Linear(15, 20)
        self.fc2 = nn.Linear(20, 10)
...
class TopModelForPHISHING(nn.Module):
    def __init__(self):
        super(TopModelForPHISHING, self).__init__()
        self.fc1top = nn.Linear(20, 20)
        self.fc2top = nn.Linear(20, 10)
        self.fc3top = nn.Linear(10, 2)
        self.bn0top = nn.BatchNorm1d(20)
        self.bn1top = nn.BatchNorm1d(20)
        self.bn2top = nn.BatchNorm1d(10)
        self.apply(weights_init)
...
class FC_PHISHING(nn.Module):
    def __init__(self, num_passive):
        super(FC_PHISHING, self).__init__()
        self.num_passive = num_passive
        self.passive = nn.ModuleList([
            BottomModelForPHISHING0().cuda(),
            BottomModelForPHISHING1().cuda(),           
        ])
        self.active = TopModelForPHISHING().cuda()
...
class FC_ADULT(nn.Module):
    def __init__(self, num_passive):
        super(FC_ADULT, self).__init__()
        self.num_passive = num_passive
        self.passive = nn.ModuleList([
            BottomModelForADULT().cuda(),
            BottomModelForADULT().cuda(),           
        ])
        self.active = TopModelForADULT().cuda()
...
class BottomModelForFC_LETTER(nn.Module):
    def __init__(self):
        super(BottomModelForFC_LETTER, self).__init__()
...
class TopModelForFC_LETTER(nn.Module):
    def __init__(self):
        super(TopModelForFC_LETTER, self).__init__()
        self.fc1top = nn.Linear(20, 20)
        self.fc2top = nn.Linear(20, 10)
        self.fc3top = nn.Linear(10, 26)
        self.bn0top = nn.BatchNorm1d(20)
        self.bn1top = nn.BatchNorm1d(20)
        self.bn2top = nn.BatchNorm1d(10)
        self.apply(weights_init)
...
class FC_LETTER(nn.Module):
    def __init__(self, num_passive):
        super(FC_LETTER, self).__init__()
        self.num_passive = num_passive
        self.passive = nn.ModuleList([
            BottomModelForFC_LETTER().cuda(),
            BottomModelForFC_LETTER().cuda(),           
        ])
        self.active = TopModelForFC_LETTER().cuda()
